...
Definitions:
- Patches: Code modifications that directly change the original Java file (How Neo/Forge works)
- Mixins: Code modifications that are injected into the original Java file at launch (How Fabric works)
